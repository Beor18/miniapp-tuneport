...
const RegisterFanModal = ({
  ...
  const handleSubmit = async (e: any) => {
    ...
    setTimeout(() => {
      toast({
        title: "Fan User Created",
        description: "Your fan profile has been successfully created.",
      });
...
export default RegisterFanModal;
