  ...
  return (
    <div className="flex items-center">
      <Button
        ...
        className="text-sm bg-zinc-800 hover:bg-zinc-700 text-white border border-zinc-700 hover:border-zinc-600 transition-colors duration-200 flex items-center gap-1.5 px-3 py-1.5 rounded text-sm"
      >
      ...
      <Dialog open={showModal} onOpenChange={setShowModal}>
        <DialogContent className="w-[95vw] sm:w-[500px] md:w-[600px] lg:w-[700px] max-h-[90vh] bg-zinc-900 border border-zinc-800 text-zinc-100 shadow-xl overflow-y-auto flex flex-col p-6">
          <DialogHeader className="mb-6 relative flex-shrink-0">
            <Button
              onClick={() => setShowModal(false)}
              className="absolute top-0 right-0 h-8 w-8 p-0 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 hover:border-zinc-600 rounded-full transition-colors duration-200 z-10"
